...
namespace COM3D2.FacilityUtill.Plugin
{
    class FacilityUtillPatch
    {
        ...
        {
            FacilityUtillMain.MyLog.LogInfo("CharacterMgr.SetActive", f_nActiveSlotNo, f_bMan, f_maid.status.fullNameEnStyle);
        }
        ...
        {
            FacilityUtillMain.MyLog.LogInfo("CharacterMgr.Deactivate", f_nActiveSlotNo, f_bMan);
        }
    }
}

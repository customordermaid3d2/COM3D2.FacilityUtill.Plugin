...
namespace COM3D2.FacilityUtill.Plugin
{
    class FacilityUtillGUI : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            SystemShortcutAPI.AddButton(MyAttribute.PLAGIN_FULL_NAME, new Action(delegate () { FacilityUtillGUI.isGUIOn = !FacilityUtillGUI.isGUIOn; }), MyAttribute.PLAGIN_NAME + " : " + ShowCounter.Value.ToString(), MyUtill.ExtractResource(COM3D25.FacilityUtill.Plugin.Properties.Resources.icon));
        }
